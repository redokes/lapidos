...
Ext.define('Lapidos.notification.ui.Notification', {
	extend: 'Ext.window.Window',
	alias: 'widget.uxNotification',

	preventHeader: true,
	title: '',
	baseCls: 'x-notification-window',
			...
			me.el.animate({
				...
				listeners: {
					afteranimate: function () {
						...
						var index = Ext.Array.indexOf(me.manager.notifications, me);
						if (index != -1) {
							me.manager.notifications.splice(index, 1);
